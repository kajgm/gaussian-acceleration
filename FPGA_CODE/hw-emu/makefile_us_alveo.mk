...
HOST_SRCS += ./common/includes/xcl2/xcl2.cpp ./src/host.cpp 
...
$(TEMP_DIR)/gauss.xo: src/gauss.cpp
	mkdir -p $(TEMP_DIR)
	v++ $(VPP_FLAGS) $(VPP_FLAGS_$(MY_KERNEL_NAME)) -c -k gauss --temp_dir $(TEMP_DIR)  -I'$(<D)' -o'$@' '$<'
#################Make Your Changes Here####################
...
#################Make Your Changes Here####################
$(BUILD_DIR)/$(MY_KERNEL_NAME).xclbin: $(TEMP_DIR)/gauss.xo
	mkdir -p $(BUILD_DIR)
