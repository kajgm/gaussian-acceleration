; ModuleID = 'C:/KDevelop/gaussian-acceleration/gauss.prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline
define void @apatb_gauss_ir(float* %A, float* %B, float* %X) local_unnamed_addr #0 {
entry:
  %A_copy = alloca [256 x float], align 512
  %B_copy = alloca [16 x float], align 512
  %X_copy = alloca [16 x float], align 512
  %0 = bitcast float* %A to [256 x float]*
  %1 = bitcast float* %B to [16 x float]*
  %2 = bitcast float* %X to [16 x float]*
  call fastcc void @copy_in([256 x float]* %0, [256 x float]* nonnull align 512 %A_copy, [16 x float]* %1, [16 x float]* nonnull align 512 %B_copy, [16 x float]* %2, [16 x float]* nonnull align 512 %X_copy)
  %3 = getelementptr inbounds [256 x float], [256 x float]* %A_copy, i32 0, i32 0
  %4 = getelementptr inbounds [16 x float], [16 x float]* %B_copy, i32 0, i32 0
  %5 = getelementptr inbounds [16 x float], [16 x float]* %X_copy, i32 0, i32 0
  call void @apatb_gauss_hw(float* %3, float* %4, float* %5)
  call fastcc void @copy_out([256 x float]* %0, [256 x float]* nonnull align 512 %A_copy, [16 x float]* %1, [16 x float]* nonnull align 512 %B_copy, [16 x float]* %2, [16 x float]* nonnull align 512 %X_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in([256 x float]* readonly, [256 x float]* noalias align 512, [16 x float]* readonly, [16 x float]* noalias align 512, [16 x float]* readonly, [16 x float]* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([256 x float]*, [256 x float]* noalias readonly align 512, [16 x float]*, [16 x float]* noalias readonly align 512, [16 x float]*, [16 x float]* noalias readonly align 512) unnamed_addr #4 {
entry:
...
declare void @apatb_gauss_hw(float*, float*, float*)

define void @gauss_hw_stub_wrapper(float*, float*, float*) #5 {
entry:
